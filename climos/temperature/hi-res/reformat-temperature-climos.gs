*
* reformat-temperature-climos.gs - Reformat the hi-res temperature climatology for compatibility with the jawf-geotiff-generator application
*
* Usage:
*   cd ${JAWF_GEOTIFFS}/climos/temperature/hi-res
